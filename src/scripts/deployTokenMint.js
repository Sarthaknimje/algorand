...
async function deployContract() {
    try {
        ...
        const approvalProgram = fs.readFileSync('src/contracts/token_mint_approval.teal', 'utf8');
        const clearProgram = fs.readFileSync('src/contracts/token_mint_clear.teal', 'utf8');
        ...
        console.log('Token Mint Contract deployed successfully!');
