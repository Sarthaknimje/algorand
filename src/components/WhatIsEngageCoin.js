...
const WhatIsEngageCoin = () => {
  const features = [
    {
      icon: RocketLaunchIcon,
      title: "Token Creation",
      description: "Creators can launch their own tokens with just a few clicks.",
      color: "from-primary to-secondary"
    },
    {
      icon: CurrencyDollarIcon,
      title: "Value Growth",
      description: "Tokens increase in value as channels grow and gain subscribers.",
      color: "from-secondary to-accent"
    },
    {
      icon: UserGroupIcon,
      title: "Community Building",
      description: "Fans can support creators and participate in channel growth.",
      color: "from-accent to-primary"
    },
    {
      icon: ShieldCheckIcon,
      title: "Secure Platform",
      description: "Built on Algorand blockchain with advanced security features.",
      color: "from-primary to-secondary"
    }
  ];
    ...
    <section className="relative py-20 bg-gradient-to-b from-dark via-dark-lighter to-dark overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          >
            A revolutionary platform that enables creators to tokenize their YouTube channels and build stronger communities.
          </motion.p>
        </motion.div>
...
export default WhatIsEngageCoin; 