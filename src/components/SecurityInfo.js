  ...
  const securityFeatures = [
    {
      ...
      title: "Algorand Layer 1",
      description: "Built on the most secure and scalable blockchain",
      color: "from-primary to-secondary"
    },
    {
      icon: CubeIcon,
      title: "ASA Standards",
      description: "Algorand Standard Assets ensure compatibility and security",
      color: "from-secondary to-accent"
    },
    {
      icon: DocumentTextIcon,
      title: "ARC-53 Metadata",
      description: "IPFS-based metadata for transparent creator tokens",
      color: "from-accent to-primary"
    },
    {
      icon: LockClosedIcon,
      title: "Multisig Security",
      description: "Optional multisig for enhanced transaction security",
      color: "from-primary to-secondary"
    }
  ];
    ...
    <section className="relative py-20 bg-gradient-to-b from-dark via-dark-lighter to-dark overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          >
            Secure and scalable infrastructure for creator tokens
          </motion.p>
        </motion.div>
