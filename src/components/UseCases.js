    ...
    <section className="relative py-20 bg-gradient-to-b from-dark via-dark-lighter to-dark overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          >
            Discover how EngageCoin transforms creator monetization
          </motion.p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="space-y-6">
              {userCases.map((useCase, index) => (
                ...
                >
                  <div className={`absolute inset-0 bg-gradient-to-r ${useCase.color} rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity`} />
                  <div className="relative p-6 rounded-2xl bg-white/5 backdrop-blur-lg border border-white/10 hover:border-primary/50 transition-all duration-300">
                    <div className="flex items-start space-x-4">
                      <div className={`w-12 h-12 rounded-xl bg-gradient-to-r ${useCase.color} p-2 group-hover:shadow-glow transition-all duration-300`}>
          ...
          >
            ...
            <div className="space-y-6">
              {creatorCases.map((useCase, index) => (
                <motion.div
                  key={index}
                  variants={itemVariants}
                  whileHover={{ y: -5, scale: 1.02 }}
